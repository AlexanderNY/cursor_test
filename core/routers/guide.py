...
DEFAULT_BLOCKS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "body": (
            ...
            "### Calendar\n"
            "Отложенные jobs, drag-and-drop, best times (Standard+), очередь pending approval.\n\n"
            "### Inbox\n"
    ...
    },
    {
        ...
        "body": (
            ...
            "- Целей/job: 1 · Расписание: 7 дней · Статистика: 7 дней\n"
            ...
            "- Целей/job: 5 · Расписание: 30 дней · AI: 100/мес · Automations: 5 · Статистика: 90 дней\n"
            ...
            "- Целей/job: 20 · Расписание: 90 дней · AI: 2 000/мес · Automations: 50 · Статистика: 365 дней\n"
