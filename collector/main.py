...
async def get_status():
    ...
    return ServiceStatus(
        ...
        collector=LoopStatus(
            ...
            loop_active=_collect_task is not None and not _collect_task.done(),
            cycle_in_progress=collect_service.cycle_in_progress,
        ),
        distributor=LoopStatus(
            ...
            loop_active=_distribute_task is not None and not _distribute_task.done(),
            cycle_in_progress=distribute_service.cycle_in_progress,
        ),
