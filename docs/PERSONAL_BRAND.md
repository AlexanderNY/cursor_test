...
Черновики выпусков S01E01–E19 (текст канала, лабы, ссылки, mermaid): [telegram-s01](telegram-s01/).
UTM регистрации: `https://www.copyparse.ru/sign-up?utm_source=tg&utm_campaign=s01eXX`.
Шаблон релиз-постов (трек C): [RELEASES.md](RELEASES.md).
