...
import type { GameLeaderboardEntry, GameSessionStats } from '@/types/game'
...
export function RatingSection({ modeId, modeTitle }: RatingSectionProps) {
    ...
    <Card className="mt-6">
      <CardHeader>
        ...
        <CardDescription>
          ...
          {modeTitle ? ` · фильтр по режиму «${modeTitle}»` : ''}. Обновляется при загрузке страницы.
        </CardDescription>
      </CardHeader>
