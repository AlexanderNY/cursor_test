  ...
  return (
    <PageContainer maxWidth="wide">
      <PageHeader
        ...
        description="Пользователи и группы, статистика, уведомления, таблицы постов, расписания, S3 и сведения о окружении. Мониторинг сервисов — в разделе Диагностика."
      />
